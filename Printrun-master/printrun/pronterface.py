...
# Test 2
        m = wx.Menu()
        showpicture = m.Append(wx.ID_ANY, 'Show Picture', 'Show Picture')
        self.Bind(wx.EVT_MENU, self.OnShowPicture, showpicture)
        #self.Bind(wx.EVT_MENU, self.CreateMenuBar(), m.Append(-1, _("&Test 2")), ("Show about dialog"))
        #self.Bind(wx.EVT_MENU, lambda *e: PronterOptions(self), m.Append(-1, _("&Options"), _(" Options dialog")))
...
#        menubar = wx.MenuBar()
#        filemenu = wx.Menu()
#        showpicture = filemenu.Append(wx.ID_ANY, 'Show Picture', 'Show Picture')
...
# 2023/2/27 移植print file 方法 到自定义菜单
    ...
    def OnShowPicture(self, event):
        ...
        img = wx.Image("example.png", wx.BITMAP_TYPE_ANY)
